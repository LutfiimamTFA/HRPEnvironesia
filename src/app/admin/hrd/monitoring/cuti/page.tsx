...
export default function CutiPage() {
  ...
  return (
    <DashboardLayout pageTitle="Manajemen Cuti" menuConfig={menuConfig}>
      <Card>
        <CardHeader>
        ...
        <CardContent className="h-96 flex flex-col items-center justify-center text-center">
          ...
          <p className="font-semibold">Halaman Manajemen Cuti</p>
          <p className="text-sm text-muted-foreground">Fungsionalitas untuk melihat, menyetujui, dan menolak pengajuan cuti akan ada di sini.</p>
        </CardContent>
      </Card>
    </DashboardLayout>
  );

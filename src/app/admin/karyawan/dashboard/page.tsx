      ...
      <div className="space-y-6">
        ...
        {!isProfileComplete && (
          <Card className="border-primary/50 bg-primary/5">
            <CardHeader>
              ...
              <CardDescription>
                Data diri Anda belum lengkap. Mohon lengkapi untuk mengakses
                semua fitur kepegawaian dan mengajukan izin atau cuti.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
        ...
        {isProfileComplete && isDataIncomplete && (
          <Alert>
            ...
            <AlertDescription>
              Informasi jabatan, divisi, atau atasan Anda belum diatur. Beberapa
              fitur mungkin belum berfungsi. Harap hubungi HRD.
            </AlertDescription>
          </Alert>
        )}
      </div>

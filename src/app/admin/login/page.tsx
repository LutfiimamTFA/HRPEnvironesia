    ...
    <div className="relative h-screen w-full overflow-hidden bg-[#10141b] flex flex-col">
      ...
      <div className="hidden lg:flex flex-col h-screen relative">
        ...
        <div className="flex flex-1 justify-center px-6">
          ...
          <div className="flex w-1/2 flex-col items-center justify-start border-r border-slate-800/50 px-6 pt-4 pb-8 overflow-y-auto">
              ...
              <div className="space-y-3 border-t border-slate-800/50 pt-4 text-center">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-col items-center gap-0.5 rounded-lg border border-teal-500/20 bg-teal-500/5 px-2.5 py-1.5">
                    ...
                    <p className="text-xs font-semibold text-white">Data Karyawan</p>
                  ...
                  <div className="flex flex-col items-center gap-0.5 rounded-lg border border-teal-500/20 bg-teal-500/5 px-2.5 py-1.5">
                    ...
                    <p className="text-xs font-semibold text-white">Izin & Cuti</p>
                    <p className="text-xs text-slate-500">
                  ...
                  <div className="flex flex-col items-center gap-0.5 rounded-lg border border-teal-500/20 bg-teal-500/5 px-2.5 py-1.5">
                    ...
                    <p className="text-xs font-semibold text-white">Monitoring</p>
                    <p className="text-xs text-slate-500">

    ...
    <div className="relative min-h-[100dvh] w-full overflow-y-auto bg-slate-50 dark:bg-[#10141b]">
      ...
      <div className="hidden lg:flex flex-col min-h-[100dvh]">
        ...
        <div className="flex flex-1 justify-center px-6 pb-10">
          ...
          {/* LEFT PANEL — Branding */}
          <div className="flex w-1/2 flex-col items-center border-r border-slate-200 bg-white px-6 pb-8 pt-2 dark:border-slate-800/50 dark:bg-transparent">
            <div className="w-full max-w-[480px] space-y-5">
              ...
              <div className="space-y-3 border-t border-slate-200 pt-4 text-center dark:border-slate-800/50">
                <p className="text-xs font-bold uppercase tracking-[0.3em] text-slate-600 dark:text-slate-500">
                  Fitur Portal
                </p>
                <div className="space-y-1.5">
                  {[
                    { icon: Briefcase,    title: 'Lowongan Tersedia', desc: 'Cari pekerjaan yang sesuai.' },
                    { icon: FileText,     title: 'Lamaran Saya',      desc: 'Kelola lamaran kerja.' },
                    { icon: CheckCircle2, title: 'Status Seleksi',    desc: 'Pantau progres Anda.' },
                    { icon: User,         title: 'Profil Kandidat',   desc: 'Kelola data profil Anda.' },
          ...
          <div className="flex w-1/2 flex-col items-center px-6 pb-8 pt-2">
            <div className="w-full max-w-[480px]">
              ...
              <p className="mt-3 text-center text-xs text-slate-500 dark:text-slate-600">
                © Environesia Group — Career Portal
              </p>
            </div>
          </div>
        </div>
...
export default function CandidateLoginPage() {
  return (
    <Suspense
      fallback={
        <div className="flex min-h-[100dvh] w-full items-center justify-center bg-slate-50 dark:bg-[#10141b]">
          <Loader2 className="h-8 w-8 animate-spin text-teal-500" />
        </div>
      }
    >

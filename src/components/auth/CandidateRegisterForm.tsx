      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-bold uppercase tracking-wide text-slate-300">Nama Lengkap (Sesuai KTP)</FormLabel>
                <FormControl>
                  <Input
                    placeholder="John Doe"
                    {...field}
                    autoComplete="name"
                    className="h-10 rounded-lg border bg-slate-800/50 border-slate-600 text-white placeholder:text-slate-500"
                  />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-bold uppercase tracking-wide text-slate-300">Alamat Email</FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-bold uppercase tracking-wide text-slate-300">Konfirmasi Email</FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-bold uppercase tracking-wide text-slate-300">Password</FormLabel>
                <FormControl>
                  <div className="relative">
                    <Input
                      type={showPassword ? 'text' : 'password'}
                      placeholder="Minimal 8 karakter"
                      className="h-10 pr-10 rounded-lg border bg-slate-800/50 border-slate-600 text-white placeholder:text-slate-500"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs font-bold uppercase tracking-wide text-slate-300">Konfirmasi Password</FormLabel>
                <FormControl>
                  <div className="relative">
                    <Input
          ...
          <FormField
            ...
            name="captcha"
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border border-slate-600 bg-slate-800/30 p-3">
                <FormControl>
                  <Checkbox
                    checked={field.value}
          ...
          <Button
            type="submit"
            className="w-full h-10 mt-4 rounded-lg font-bold text-sm bg-teal-500 hover:bg-teal-600 text-slate-950"
            disabled={loading}
          >

...
> = {
  ...
  pending_completion_confirmation: {
    managerLabel: "Menunggu Konfirmasi Selesai",
    hrdLabel: "Menunggu Konfirmasi Staff",
    className: "bg-sky-100 text-sky-800 dark:bg-sky-900/30 dark:text-sky-300 border border-sky-500/20",
  },
  completed_confirmed: {
    managerLabel: "Selesai Dikonfirmasi",
    hrdLabel: "Selesai Dikonfirmasi",
    className: "bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300 border border-teal-500/20",
  },
  duration_needs_review: {
    managerLabel: "Perlu Review Tambahan Durasi",
    hrdLabel: "Perlu Review Tambahan Durasi",
    className: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300 border border-orange-500/20",
  },
};

...
interface WorkExperienceFormProps {
    ...
    onSave: (data: WorkExperience[]) => Promise<void>;
    isSaving: boolean;
}
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Tambahkan pengalaman kerja yang relevan.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
                                     ...
                                     <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl><Input type="number" {...field} placeholder="YYYY" disabled={form.watch(`experience.${index}.isCurrent`)} /></FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                            ...
                                            <div className="space-y-1 leading-none">
                                                <FormLabel>Saat ini masih bekerja di sini</FormLabel>
                                            </div>
                                        </FormItem>
                                    )}
                                />
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => append({ id: crypto.randomUUID(), company: '', position: '', startDate: '', endDate: '', isCurrent: false, description: '' })}
                        >

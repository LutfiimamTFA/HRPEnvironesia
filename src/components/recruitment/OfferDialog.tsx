...
export function OfferDialog({ open, onOpenChange, onConfirm, candidateName, job }: OfferDialogProps) {
  ...
  const [stagedOfferData, setStagedOfferData] = useState<OfferFormData | null>(null);
      ...
      <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    Anda akan mengirimkan penawaran kontrak kepada {candidateName}. Setelah dikirim, penawaran ini tidak dapat diubah. Pastikan semua detail sudah benar.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
                <AlertDialogCancel>Batal</AlertDialogCancel>
                <AlertDialogAction onClick={handleConfirmSubmit} disabled={isSaving}>
